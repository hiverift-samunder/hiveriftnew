...
export function ServiceDetailPage({
  ...
  const serviceData: { [key: string]: any } = {
    "web-development": {
      ...
      heroImage:
        "https://images.unsplash.com/photo-1593720213681-e9a8778330a7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWIlMjBkZXZlbG9wbWVudCUyMGNvZGluZyUyMHByb2dyYW1tZXJ8ZW58MXx8fHwxNzU4MTg4ODM5fDA&ixlib=rb-4.1.0&q=80&w=1080",
      overview:
        "From simple landing pages to complex web applications, our custom website development services are designed to create digital experiences that not only look stunning but also drive measurable business results. We combine cutting-edge technology with user-centered design to build websites that engage your audience and convert visitors into customers.",
      keyFeatures: [
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Our designers create wireframes and interactive prototypes that visualize the user experience and interface design.",
        },
        {
          step: "Development & Integration",
          description:
            "Our developers build your website using modern frameworks and integrate necessary third-party services.",
        },
        {
          step: "Testing & Launch",
          description:
            "Comprehensive testing across devices and browsers ensures your website performs flawlessly before going live.",
        },
        {
          step: "Maintenance & Support",
          description:
            "Ongoing updates, security patches, and performance optimization keep your website running smoothly.",
        },
      ],
      technologies: [
        "React",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We provide detailed project timelines during the planning phase based on your specific requirements and scope.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Absolutely! We seamlessly integrate your existing brand identity, colors, fonts, and style guidelines into the website design.",
        },
      ],
    },
    "mobile-app-development": {
      ...
      subtitle:
        "Native and cross-platform applications that engage users and drive business objectives",
      heroImage:
      ...
      process: [
        ...
        },
        {
          step: "UI/UX Design",
          description:
            "Our designers create intuitive interfaces that follow platform-specific guidelines while maintaining your brand identity.",
        },
        {
          step: "Development & Testing",
          description:
            "Native or cross-platform development with rigorous testing across multiple devices and operating system versions.",
        },
        {
          step: "App Store Submission",
          description:
            "We handle the complete app store submission process, including optimization for better discoverability.",
        },
        {
          step: "Post-Launch Support",
          description:
            "Ongoing updates, bug fixes, and feature enhancements keep your app competitive and user-friendly.",
        },
      ],
      technologies: [
        "React Native",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Costs vary significantly based on features, complexity, and platform choice. We provide detailed quotes after understanding your specific requirements during our discovery phase.",
        },
        {
          question: "Do you help with app store submissions?",
          answer:
            "Yes, we handle the complete app store submission process, including creating store listings, screenshots, and managing the approval process for both Apple App Store and Google Play Store.",
        },
        {
          question: "Can you integrate the app with our existing systems?",
          answer:
            "Absolutely! We specialize in integrating mobile apps with existing CRM systems, databases, payment gateways, and other business tools through APIs.",
        },
      ],
    },
    "mvp-development": {
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Define the essential features that will deliver maximum value to users while keeping development time minimal.",
        },
        {
          step: "Rapid Development",
          description:
            "Build the MVP using agile methodologies, focusing on core functionality and user experience essentials.",
        },
        {
          step: "Testing & Launch",
          description:
            "Deploy the MVP to a controlled user group and gather valuable feedback and usage analytics.",
        },
        {
          step: "Iteration & Scaling",
          description:
            "Based on user feedback and metrics, iterate on features and plan for full product development.",
        },
      ],
      technologies: [
        "React",
      ...
      faqs: [
        {
          ...
          answer:
            "MVP focuses on core features to test market viability quickly and cost-effectively, while full development includes comprehensive features, advanced integrations, and polished user experience.",
        },
        {
          question:
            "How do you determine which features to include in the MVP?",
          answer:
            "We work with you to identify features that directly address your core value proposition and are essential for users to understand and experience your product's main benefits.",
        },
        {
          question: "Can the MVP be scaled into a full product later?",
          answer:
            "Absolutely! We build MVPs with scalable architecture, so they can serve as the foundation for full product development based on validated learnings and user feedback.",
        },
        {
          question: "How do you measure MVP success?",
          answer:
            "We implement analytics to track user engagement, feature usage, conversion rates, and other relevant KPIs that help validate your business assumptions.",
        },
      ],
    },
    "blockchain-solutions": {
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Design the blockchain architecture, smart contracts, and integration points with your existing systems.",
        },
        {
          step: "Development & Testing",
          description:
            "Build and rigorously test smart contracts and DApps on testnets before mainnet deployment.",
        },
        {
          step: "Security Audit",
          description:
            "Comprehensive security audits ensure your blockchain solution is secure and follows best practices.",
        },
        {
          step: "Deployment & Monitoring",
          description:
            "Deploy to mainnet and provide ongoing monitoring and maintenance for optimal performance.",
        },
      ],
      technologies: [
        "Ethereum",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Blockchain is inherently secure due to its decentralized nature, but smart contract code must be properly audited. We follow security best practices and conduct thorough audits before deployment.",
        },
        {
          question:
            "What are the costs associated with blockchain development?",
          answer:
            "Costs include development, gas fees for deployment, and ongoing transaction costs. We provide transparent estimates and help optimize for cost-efficiency.",
        },
        {
          question: "Can blockchain integrate with our existing systems?",
          answer:
            "Yes, we specialize in creating hybrid solutions that integrate blockchain technology with your existing databases, APIs, and business systems.",
        },
      ],
    },
    "ecommerce-development": {
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Choose the optimal e-commerce platform or decide on custom development based on your needs and scalability requirements.",
        },
        {
          step: "Design & Development",
          description:
            "Create user-friendly interfaces, implement secure payment systems, and develop robust backend functionality.",
        },
        {
          step: "Integration & Testing",
          description:
            "Integrate with payment gateways, shipping providers, and third-party services while ensuring security and performance.",
        },
        {
          step: "Launch & Optimization",
          description:
            "Deploy your e-commerce platform and continuously optimize based on user behavior and performance metrics.",
        },
      ],
      technologies: [
        "Shopify",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We implement industry-standard security measures including SSL certificates, PCI compliance, secure payment gateways, and fraud protection to ensure safe transactions.",
        },
        {
          question: "Can you integrate with my existing inventory system?",
          answer:
            "Yes, we can integrate your e-commerce platform with existing ERP, CRM, and inventory management systems through APIs to maintain synchronized data across platforms.",
        },
        {
          question: "Do you provide ongoing e-commerce support?",
          answer:
            "We offer comprehensive support including security updates, performance optimization, feature enhancements, and technical support to keep your store running smoothly.",
        },
      ],
    },
    "api-development": {
      ...
      subtitle:
        "Connect your systems and streamline operations with custom APIs",
      heroImage:
      ...
      process: [
        ...
        },
        {
          step: "API Design",
          description:
            "Create comprehensive API specifications, including endpoints, data models, and authentication mechanisms.",
        },
        {
          step: "Development & Testing",
          description:
            "Build robust APIs with proper error handling, validation, and comprehensive testing for reliability.",
        },
        {
          step: "Documentation & Security",
          description:
            "Create detailed documentation and implement security measures including authentication, authorization, and rate limiting.",
        },
        {
          step: "Integration & Monitoring",
          description:
            "Deploy APIs and integrate with your systems while setting up monitoring and analytics for performance tracking.",
        },
      ],
      technologies: [
        "Node.js",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We implement multiple security layers including authentication, authorization, rate limiting, input validation, HTTPS encryption, and regular security audits.",
        },
        {
          question: "Can you integrate with existing third-party services?",
          answer:
            "Yes, we specialize in integrating with popular third-party services like payment gateways, CRM systems, marketing tools, and social media platforms through their APIs.",
        },
        {
          question: "Do you provide API documentation?",
          answer:
            "Absolutely! We create comprehensive API documentation including endpoint descriptions, request/response examples, authentication details, and integration guides.",
        },
      ],
    },
    "ui-ux-design": {
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Structure content and functionality to create logical, intuitive navigation and user flows.",
        },
        {
          step: "Wireframing & Prototyping",
          description:
            "Create low-fidelity wireframes and interactive prototypes to test concepts before visual design.",
        },
        {
          step: "Visual Design",
          description:
            "Apply your brand identity to create beautiful, consistent interfaces that engage and delight users.",
        },
        {
          step: "Testing & Iteration",
          description:
            "Conduct usability testing and iterate on designs based on user feedback and performance data.",
        },
      ],
      technologies: [
        "Figma",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Yes, user research is a crucial part of our design process. We conduct interviews, surveys, and usability testing to understand user needs and validate design decisions.",
        },
        {
          question: "Can you work with our development team?",
          answer:
            "Absolutely! We collaborate closely with development teams, providing detailed design specifications, assets, and ongoing support throughout the implementation process.",
        },
        {
          question: "Do you create design systems?",
          answer:
            "Yes, we create comprehensive design systems that include style guides, component libraries, and documentation to ensure consistency across all touchpoints.",
        },
      ],
    },
    "brand-identity-design": {
      ...
      subtitle:
        "Complete brand identity packages that reflect your unique value proposition",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Create initial brand concepts, logos, and visual directions based on discovery insights and strategic positioning.",
        },
        {
          step: "Design Refinement",
          description:
            "Refine selected concepts, develop color palettes, typography, and create comprehensive brand guidelines.",
        },
        {
          step: "Asset Creation",
          description:
            "Design complete brand asset library including logos, icons, templates, and marketing materials.",
        },
        {
          step: "Brand Implementation",
          description:
            "Apply brand identity across all touchpoints and provide guidelines for consistent brand implementation.",
        },
      ],
      technologies: [
        "Adobe Illustrator",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We provide detailed project timelines during the discovery phase based on your specific requirements and scope of work.",
        },
        {
          question: "Can you redesign an existing brand?",
          answer:
            "Yes, we specialize in brand evolution and redesign while maintaining brand equity and customer recognition where appropriate.",
        },
        {
          question: "Do you provide brand guidelines?",
          answer:
            "Absolutely! We create comprehensive brand guidelines that cover logo usage, colors, typography, voice, and application examples to ensure consistent brand implementation.",
        },
      ],
    },
    "digital-marketing": {
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Develop a comprehensive digital marketing strategy aligned with your business goals and budget.",
        },
        {
          step: "Campaign Implementation",
          description:
            "Execute multi-channel campaigns across search engines, social media, email, and other digital platforms.",
        },
        {
          step: "Performance Monitoring",
          description:
            "Track key metrics and KPIs to measure campaign performance and identify optimization opportunities.",
        },
        {
          step: "Optimization & Growth",
          description:
            "Continuously optimize campaigns based on data insights to improve ROI and drive sustainable growth.",
        },
      ],
      technologies: [
        "Google Analytics",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We track relevant KPIs such as website traffic, lead generation, conversion rates, cost per acquisition, and ROI. We provide regular reports with actionable insights.",
        },
        {
          question: "Do you handle social media management?",
          answer:
            "Yes, we provide comprehensive social media management including content creation, community management, paid advertising, and performance analytics across all major platforms.",
        },
        {
          question: "Can you work with our existing marketing tools?",
          answer:
            "Absolutely! We integrate with popular marketing tools like CRM systems, email platforms, and analytics tools to create a seamless marketing ecosystem.",
        },
      ],
    },
    "cloud-migration": {
      ...
      subtitle:
        "Seamless migration to modern cloud platforms for scalability and efficiency",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Design the optimal migration approach whether it's lift-and-shift, re-platforming, or complete modernization.",
        },
        {
          step: "Pilot Migration",
          description:
            "Start with a pilot project to validate the migration approach and identify any potential issues.",
        },
        {
          step: "Full Migration",
          description:
            "Execute the complete migration plan with minimal downtime and business impact.",
        },
        {
          step: "Optimization & Support",
          description:
            "Optimize performance, costs, and security while providing ongoing support and monitoring.",
        },
      ],
      technologies: [
        "AWS",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We provide detailed project timelines during the planning phase based on the complexity and size of your infrastructure.",
        },
        {
          question: "What about data security during migration?",
          answer:
            "We follow industry best practices for secure data migration, including encryption, secure transfer protocols, and comprehensive backup strategies to ensure data integrity.",
        },
        {
          question: "Do you provide post-migration support?",
          answer:
            "Yes, we provide comprehensive post-migration support including monitoring, optimization, troubleshooting, and ongoing maintenance to ensure optimal performance.",
        },
      ],
    },
    "mobile-app-ui-design": {
      ...
      subtitle:
        "Platform-specific mobile interfaces that enhance user experience and engagement",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Create detailed user flows and wireframes optimized for mobile interactions and navigation patterns.",
        },
        {
          step: "Visual Design",
          description:
            "Design high-fidelity interfaces following platform guidelines while maintaining brand consistency.",
        },
        {
          step: "Interactive Prototyping",
          description:
            "Create interactive prototypes to test gestures, animations, and micro-interactions.",
        },
        {
          step: "Asset Preparation",
          description:
            "Prepare all design assets, specifications, and app store materials for development and submission.",
        },
      ],
      technologies: [
        "Figma",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Our service includes wireframes, high-fidelity designs, interactive prototypes, design specifications, app icons, and all necessary app store assets.",
        },
        {
          question: "How do you ensure designs work on different screen sizes?",
          answer:
            "We create adaptive designs using responsive grids and flexible layouts that work seamlessly across various device sizes and orientations.",
        },
        {
          question: "Do you provide design handoff for developers?",
          answer:
            "Yes, we provide detailed design specifications, asset files, and use tools like Figma or Zeplin to ensure smooth handoff to development teams.",
        },
      ],
    },
    "landing-page-design": {
      ...
      subtitle:
        "High-converting landing pages optimized for lead generation and conversions",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Analyze competitor landing pages and industry best practices to identify optimization opportunities.",
        },
        {
          step: "Design Creation",
          description:
            "Create conversion-focused designs with clear value propositions and compelling calls-to-action.",
        },
        {
          step: "A/B Test Design",
          description:
            "Develop multiple design variations for A/B testing to optimize conversion rates.",
        },
        {
          step: "Performance Optimization",
          description:
            "Optimize designs for fast loading times and implement tracking for conversion analysis.",
        },
      ],
      technologies: [
        "Figma",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Yes, we create multiple design variations to A/B test different elements like headlines, CTAs, layouts, and colors to optimize conversion rates.",
        },
        {
          question: "How do you measure landing page success?",
          answer:
            "We track metrics like conversion rate, bounce rate, time on page, scroll depth, and form completion rates to measure and optimize performance.",
        },
        {
          question: "Can you integrate with our marketing tools?",
          answer:
            "Yes, we can integrate landing pages with popular marketing tools like CRM systems, email marketing platforms, analytics tools, and ad networks.",
        },
      ],
    },
    "seo-content-marketing": {
      ...
      subtitle:
        "Strategic content creation and optimization to boost search rankings and engagement",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Research and develop a targeted keyword strategy based on search volume, competition, and business goals.",
        },
        {
          step: "Content Planning",
          description:
            "Create a content calendar and strategy that aligns with SEO goals and audience interests.",
        },
        {
          step: "Content Creation",
          description:
            "Develop high-quality, SEO-optimized content including blogs, articles, guides, and landing pages.",
        },
        {
          step: "Optimization & Monitoring",
          description:
            "Continuously optimize content and monitor rankings, traffic, and engagement metrics for ongoing improvement.",
        },
      ],
      technologies: [
        "Google Analytics",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We create various content types including blog posts, articles, guides, infographics, videos, case studies, and landing pages, all optimized for search engines.",
        },
        {
          question: "Do you handle local SEO?",
          answer:
            "Yes, we provide local SEO services including Google My Business optimization, local citations, review management, and location-specific content creation.",
        },
        {
          question: "How do you measure SEO success?",
          answer:
            "We track metrics like organic traffic, keyword rankings, click-through rates, bounce rate, time on page, and conversions to measure and report on SEO performance.",
        },
      ],
    },
    "operations-consultancy": {
      ...
      subtitle:
        "Strategic guidance to optimize business operations and maximize efficiency",
      heroImage:
      ...
      process: [
        ...
        },
        {
          step: "Gap Analysis",
          description:
            "Compare current performance with industry best practices and desired future state to identify gaps.",
        },
        {
          step: "Strategy Development",
          description:
            "Develop customized improvement strategies and implementation roadmaps aligned with business objectives.",
        },
        {
          step: "Implementation Support",
          description:
            "Guide and support the implementation of recommended changes with change management best practices.",
        },
        {
          step: "Performance Monitoring",
          description:
            "Establish KPIs and monitoring systems to track improvements and ensure sustainable operational excellence.",
        },
      ],
      technologies: [
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We establish baseline metrics and KPIs, then track improvements in areas like efficiency, cost reduction, quality scores, customer satisfaction, and employee productivity.",
        },
        {
          question: "Do you provide ongoing support?",
          answer:
            "Yes, we offer ongoing support to ensure sustained improvements and help adapt to changing business needs and market conditions.",
        },
        {
          question: "Can you help with digital transformation?",
          answer:
            "Absolutely! We specialize in digital transformation initiatives, helping businesses leverage technology to improve operations, automate processes, and enhance customer experiences.",
        },
      ],
    },
    "virtual-assistant": {
      ...
      subtitle:
        "Professional administrative support to help you focus on core business activities",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Select and onboard a qualified virtual assistant with relevant skills and experience for your industry and tasks.",
        },
        {
          step: "Task Setup & Training",
          description:
            "Establish clear processes, provide necessary training, and set up communication channels for seamless collaboration.",
        },
        {
          step: "Daily Operations",
          description:
            "Begin regular task execution with ongoing communication, progress updates, and quality assurance.",
        },
        {
          step: "Performance Review",
          description:
            "Regular performance reviews and process optimization to ensure maximum efficiency and satisfaction.",
        },
      ],
      technologies: [
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We implement strict security protocols including NDAs, secure access controls, encrypted communication, and regular security training for all virtual assistants.",
        },
        {
          question: "What are the working hours?",
          answer:
            "We offer flexible working arrangements and can provide support during your business hours or extend coverage for different time zones as needed.",
        },
        {
          question: "How do you handle quality control?",
          answer:
            "We have robust quality assurance processes including regular check-ins, performance reviews, task audits, and continuous training to maintain high service standards.",
        },
      ],
    },
    "email-marketing": {
      ...
      subtitle:
        "Automated email campaigns that nurture leads and drive customer engagement",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Build and segment email lists based on demographics, behavior, and preferences for targeted messaging.",
        },
        {
          step: "Campaign Creation",
          description:
            "Design and develop email templates, create compelling content, and set up automated workflows.",
        },
        {
          step: "Testing & Launch",
          description:
            "A/B test different elements like subject lines, content, and CTAs before launching campaigns.",
        },
        {
          step: "Analysis & Optimization",
          description:
            "Monitor performance metrics and continuously optimize campaigns for better engagement and conversions.",
        },
      ],
      technologies: [
        "Mailchimp",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We create welcome series, promotional campaigns, newsletters, abandoned cart emails, re-engagement campaigns, and automated drip sequences based on your needs.",
        },
        {
          question: "How do you personalize email content?",
          answer:
            "We use customer data, behavior tracking, and segmentation to personalize subject lines, content, product recommendations, and send times for each recipient.",
        },
        {
          question: "What metrics do you track?",
          answer:
            "We track open rates, click-through rates, conversion rates, unsubscribe rates, bounce rates, and ROI to measure campaign performance and optimize results.",
        },
      ],
    },
    "business-analytics": {
      ...
      subtitle:
        "Data-driven insights and reporting to make informed business decisions",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Define key metrics, KPIs, and reporting requirements based on your business goals and decision-making needs.",
        },
        {
          step: "Dashboard Development",
          description:
            "Create custom dashboards and reports that provide clear, actionable insights into your business performance.",
        },
        {
          step: "Implementation & Training",
          description:
            "Implement analytics solutions and train your team on how to interpret and use the data effectively.",
        },
        {
          step: "Ongoing Optimization",
          description:
            "Continuously refine analytics and reporting based on changing business needs and new data sources.",
        },
      ],
      technologies: [
        "Google Analytics",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We implement data validation rules, regular audits, and quality checks to ensure data accuracy and reliability in all reports and dashboards.",
        },
        {
          question: "Can you create real-time dashboards?",
          answer:
            "Yes, we can create real-time dashboards that automatically update with the latest data, allowing you to monitor business performance continuously.",
        },
        {
          question: "Do you provide training on analytics tools?",
          answer:
            "Absolutely! We provide comprehensive training on how to use dashboards, interpret data, and generate insights to maximize the value of your analytics investment.",
        },
      ],
    },
    "devops-automation": {
      ...
      subtitle:
        "Streamline development and deployment with modern DevOps practices and automation",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Design a comprehensive DevOps strategy including tool selection, process improvements, and automation roadmap.",
        },
        {
          step: "Pipeline Implementation",
          description:
            "Set up CI/CD pipelines, automated testing, and deployment processes to streamline software delivery.",
        },
        {
          step: "Monitoring & Security",
          description:
            "Implement comprehensive monitoring, logging, and security measures across the development and deployment lifecycle.",
        },
        {
          step: "Optimization & Training",
          description:
            "Continuously optimize processes and provide team training on DevOps best practices and tools.",
        },
      ],
      technologies: [
        "Docker",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Implementation varies based on complexity, but we provide detailed project timelines during our planning phase based on your specific requirements.",
        },
        {
          question: "Do you provide training for our development team?",
          answer:
            "Yes, we provide comprehensive training on DevOps tools, practices, and methodologies to ensure your team can effectively maintain and improve the implemented solutions.",
        },
        {
          question: "Can you integrate with our existing tools?",
          answer:
            "Absolutely! We work with your existing development tools and can integrate new DevOps solutions seamlessly with your current technology stack.",
        },
      ],
    },
    "database-management": {
      ...
      subtitle:
        "Professional database design, optimization, and management for peak performance",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Design optimal database architecture considering performance, scalability, security, and business requirements.",
        },
        {
          step: "Implementation & Migration",
          description:
            "Implement new database solutions or migrate existing data with minimal downtime and data integrity.",
        },
        {
          step: "Optimization & Security",
          description:
            "Fine-tune performance, implement security measures, and establish backup and recovery procedures.",
        },
        {
          step: "Monitoring & Maintenance",
          description:
            "Provide ongoing monitoring, maintenance, and support to ensure optimal database performance and availability.",
        },
      ],
      technologies: [
        "MySQL",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "We implement multiple security layers including encryption, access controls, audit logging, regular security updates, and compliance with industry standards.",
        },
        {
          question: "Can you help with database migration?",
          answer:
            "Yes, we specialize in database migrations including schema conversion, data transfer, testing, and ensuring minimal downtime during the migration process.",
        },
        {
          question: "Do you provide 24/7 database monitoring?",
          answer:
            "We offer various support levels including 24/7 monitoring and support to ensure your database systems remain available and perform optimally.",
        },
      ],
    },
    "maintenance-support": {
      ...
      subtitle:
        "Reliable technical support to keep your digital assets running smoothly and securely",
      heroImage:
      ...
      process: [
        ...
        },
        {
          ...
          description:
            "Develop a customized maintenance schedule and support plan based on your business requirements and criticality.",
        },
        {
          step: "Proactive Monitoring",
          description:
            "Implement continuous monitoring systems to detect and prevent issues before they impact your business.",
        },
        {
          step: "Regular Maintenance",
          description:
            "Execute scheduled maintenance activities including updates, optimizations, and preventive measures.",
        },
        {
          step: "Incident Response",
          description:
            "Provide rapid response and resolution for any technical issues or emergencies that arise.",
        },
      ],
      technologies: [
        "Monitoring Tools",
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Our response times vary by support level, with immediate response for critical issues and structured response times for standard requests, all outlined in our SLA.",
        },
        {
          question: "Do you provide emergency support?",
          answer:
            "Yes, we offer emergency support services with rapid response times for critical issues that could impact your business operations.",
        },
        {
          question: "Can you work with systems built by other teams?",
          answer:
            "Absolutely! We can take over maintenance and support for systems developed by other teams, starting with a comprehensive assessment and knowledge transfer.",
        },
      ],
    },
  };
  ...
  return (
    <div className="py-20">
      ...
      <SEO
        ...
        image="https://yourdomain.com/og-services.jpg"
      />
